    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var products = new List<Product>
            {
                new Product
                {
                    ProductId = 495, Brand = "maybelline",
                    Name = "Maybelline Face Studio Master Hi-Light Light Booster Bronzer", Price = 14.99,
                    ImageLink =
                ...
                new Product
                {
                    ...
                    Description =
                        "Why You'll Love It  Lightweight pigments blend easily and wear evenly ProvProductIdes a natural, fade-proof bronzed color that leaves skin the way it was meant to be...fresh, breathing and natural  For Best Results: For soft, natural look, brush along cheekbone, sweeping upward."
                },
                new Product
                {
                    ProductId = 477, Brand = "maybelline", Name = "Maybelline Facestudio Master Contour Kit",
                    Price = 15.99,
                    ImageLink =
                ...
                new Product
                {
                    ProductId = 468, Brand = "maybelline",
                    Name = "Maybelline Face Studio Master Hi-Light Light Booster Blush", Price = 14.99,
                    ImageLink =
                ...
                new Product
                {
                    ...
                    Description =
                        "Maybelline Fit Me Blush has lightweight pigments blend easily and wear evenly. It provProductIdes a natural, fade-proof cheek color that leaves skin the way it was meant to be...fresh, breathing, and natural.  For Best Results: For soft, natural look, brush along cheekbone, sweeping upward."
                },
                ...
                new Product
                {
                    ProductId = 380, Brand = "maybelline", Name = "Maybelline Fit Me Shine-Free Foundation Stick",
                    Price = 10.99,
                    ImageLink =
                ...
                new Product
                {
                    ProductId = 379, Brand = "maybelline", Name = "Maybelline Dream Matte Mousse Foundation",
                    Price = 14.79,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/029889b345c76a70e8bb978b73ed1a87_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "Maybelline Dream Matte Mouse Foundation is a revolutionary air-soft mousse that provProductIdes perfecting coverage for 100% velvet-matte complexion. It's non-comedogenic, fragrance-free, dermatologist-tested, allergy-tested and ProductIdeal for normal to oily skin.For best results: Apply smoothly and evenly to your face and blend with your fingertips.﻿   "
                },
                new Product
                {
                    ProductId = 366, Brand = "maybelline",
                    Name = "Maybelline Mineral Power Natural Perfecting Powder Foundation", Price = 14.99,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/c77ad2da76259cfd67a9a9432f635bfb_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "Why You'll Love ItMineral Power Powder Foundation with micro-minerals provProductIdes a more natural, healthier, luminous look. Discover the natural power of micro-minerals: 100% natural mica creates a more natural luminosity Complete, yet refined coverage ProvProductIdes buildable, even coverage Preservative-free, talc-free, oil-free, fragrance-free Medium to Full Coverage"
                },
                new Product
                {
                ...
                new Product
                {
                    ProductId = 353, Brand = "maybelline", Name = "Maybelline Superstay Better Skin Foundation",
                    Price = 14.99,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/c7d967ef502ecd79ab7ab466c4952d82_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "The Maybelline Superstay Better Skin Foundation reduces the appearance of spots, bumps, dullness and redness to give you brighter, smoother and more even skin. Features:Longwear that improves skin every minute you're in it: brighter, smoother and more even.With micro-flex technology and the antioxProductIdant power of Actyl-C.ProductIdeal for sensitive skin. Good for all skin types. Medium to full coverageHow to Apply: Apply evenly to your face and blend with your fingers. "
                },
                new Product
                {
                    ProductId = 339, Brand = "maybelline",
                    Name = "Maybelline Dream Wonder LiquProductId Touch Foundation", Price = 14.99,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/ccb99ad6ac7f31a2a73454bdbda01d99_ra,w158,h184_pa,w158,h184.jpeg",
                    Description =
                        "Maybelline Dream Wonder LiquProductId Touch Foundation's breakthrough texture fuses with skin. A finish so impeccable, yet undetectable.Features:Exclusive dropperMedium to full coverage, ProductIdeal for normal skinFor Best Results: Shake well. Unscrew cap. Holding dropper vertically, allow foundation to drop onto fingertip. Apply to face as usual."
                },
                new Product
                {
                    ProductId = 321, Brand = "maybelline", Name = "Maybelline Dream LiquProductId Mousse",
                    Price = 14.79,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/1ca6a4a442b9aa6b5f3d94da77d8846c_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "Airbrushed perfection made possible:Air-whipped liquProductId makeup for 100% poreless skin  Breakthrough finish cushions and smooths for the most flawless, luminous coverage Lightweight air-whipped formula blends to virtually eliminate pores and imperfections Innovative shade-match pump makes finding your perfect shade a dream  "
                },
                new Product
                {
                    ProductId = 320, Brand = "maybelline", Name = "Maybelline FIT ME! Matte + Poreless Foundation",
                    Price = 10.99,
                    ImageLink =
                ...
                new Product
                {
                    ProductId = 317, Brand = "maybelline", Name = "Maybelline Fit Me Foundation with SPF",
                    Price = 10.99,
                    ImageLink =
                ...
                new Product
                {
                    ProductId = 309, Brand = "maybelline", Name = "Maybelline Expert Wear Eye Shadow Quad",
                    Price = 8.99,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/c924006882e8e313d445a3a5394e4729_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "Easy to use, lots to choose!Maybelline Expert Wear Eye Shadow  Quads have 4 coordinating shades with step by step application guProductIde  makes shadow easier than ever. The eyeshadows glProductIde on effortlessly with  superior smoothness and the velvet-tip applicator blends without  tugging or pulling. Safe for sensitive eyes and contact lens wearers,  ophthalmologist-tested.For best results sweep the brush 4 times:Apply base color. Sweep shade on lProductId. Contour crease and blend. Line around eye."
                },
                new Product
                {
                    ProductId = 307, Brand = "maybelline",
                    Name = "Maybelline Eyestudio Color Tattoo Concentrated Crayon", Price = 10.99,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/3f9f894b56e0616e44c5ee01dea45217_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "Maybelline Eyestudio Color Tattoo Concentrated Crayons give you high-intensity color that looks vibrant all-day long.Features:Smooth, soft creamy finishPlayful intense colorsAll day tattoo tenacity. Playful color intensity. In an easy glProductIde on crayon."
                },
                new Product
                {
                    ProductId = 295, Brand = "maybelline", Name = "Maybelline The Nudes Eye Shadow Palette",
                    Price = 17.99,
                    ImageLink =
                        "https://d3t32hsnjxo7q6.cloudfront.net/i/201350fd3e173307ade44520dc87d8fb_ra,w158,h184_pa,w158,h184.png",
                    Description =
                        "Maybelline The Nudes Eye Shadow Palette let's you create looks from day to night. Deep to light. So try it out and create your ProductIdeal eye look today!Features:             13 looks in one Expert Wear eyeshadow palette Extraordinary Colour, from soft highlights, to medium bronze, to rich black From Maybelline's ultra-blendable pigments Long Wear            "
                },
                new Product
                {
